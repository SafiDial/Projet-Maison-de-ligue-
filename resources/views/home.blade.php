    ...
    <section class="accueil-section">
        <div class="accueil-content">
            ...
            <p>
                ...
                la plateforme de l'entreprise vous permet de retrouver tous vos collaborateurs.
            </p>
        </div>
    </section>

    <!--************** Section admin Bonjour****************-->
        ...
        <div class="user-greeting">
            ...
            <div class="user-info">
                <div class="user-image">
                    <img 
                        src="{{ $collaborateur->photo_url ?? asset('images/default.webp') }}" 
                        alt="Photo de {{ $collaborateur->name ?? 'collaborateur' }}" 
